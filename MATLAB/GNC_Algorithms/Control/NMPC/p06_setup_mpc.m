% filename: MATLAB/GNC_Algorithms/Control/NMPC/p06_setup_mpc.m

% Minimal NMPC setup for quadcopter hover (Problem 6)

function nmpc = p06_setup_mpc(px4_config, Ts, N)
