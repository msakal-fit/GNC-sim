...
function run_P04_LMPC_point_multi()
    ...
    N_horizon = 100;                       % prediction horizon length
    ...
    while t < flight_duration
        ...
        switch CONTROL_MODE
            case 'position'
                ...
                px4_send_trajectory(client, pos_cmd(1), pos_cmd(2), pos_cmd(3), 0, config);
        ...
        log_data.pred(:, i_log) = pos_cmd;  % store predicted position
