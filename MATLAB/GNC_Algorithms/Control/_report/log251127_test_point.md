...
t=0.0s | pos=[-0.03,0.02,-5.00] err=[-0.03,0.02,-4.00](4.00m) | vel=[0.02,-0.03,0.00] | | T=2.9N τ=[0.031,0.025,-1.226]Nm [T_SAT] [τ_SAT]
t=0.0s | pos=[-0.03,0.02,-5.00] err=[-0.03,0.02,-4.00](4.00m) | vel=[0.02,-0.03,0.00] | | T=2.9N τ=[0.031,0.025,-1.226]Nm [T_SAT] [τ_SAT]
t=8.3s | pos=[0.01,-0.02,-2.13] err=[0.01,-0.02,-1.13](1.13m) | vel=[0.00,0.02,0.19] | | T=10.5N τ=[0.023,0.027,-0.001]Nm
t=16.7s | pos=[-0.02,-0.01,-1.32] err=[-0.02,-0.01,-0.32](0.32m) | vel=[0.00,0.00,0.05] | | T=13.5N τ=[0.020,-0.017,0.001]Nm
t=25.0s | pos=[-0.00,0.05,-1.11] err=[-0.00,0.05,-0.11](0.12m) | vel=[-0.01,-0.00,0.02] | | T=14.3N τ=[-0.070,-0.003,-0.000]Nm
t=33.3s | pos=[0.00,0.01,-1.04] err=[0.00,0.01,-0.04](0.04m) | vel=[0.00,0.00,0.01] | | T=14.6N τ=[-0.006,0.017,-0.000]Nm
t=41.7s | pos=[-0.03,0.02,-1.01] err=[-0.03,0.02,-0.01](0.03m) | vel=[0.01,-0.01,0.00] | | T=14.7N τ=[-0.020,-0.028,0.001]Nm
t=50.0s | pos=[-0.00,0.00,-1.01] err=[-0.00,0.00,-0.01](0.01m) | vel=[-0.00,0.00,0.00] | | T=14.7N τ=[0.002,-0.001,-0.001]Nm
t=58.3s | pos=[-0.01,-0.00,-1.01] err=[-0.01,-0.00,-0.01](0.02m) | vel=[0.00,0.00,0.00] | | T=14.7N τ=[0.001,-0.013,-0.000]Nm
